import { PrismaClient, CommType, Criticality } from '@prisma/client';
  ...
  const services = [
    {
      ...
      communicationType: CommType.REST,
      criticalityLevel: Criticality.CRITICAL,
    ...
    },
    {
      ...
      communicationType: CommType.REST,
      criticalityLevel: Criticality.HIGH,
    ...
    },
    {
      ...
      currentVersion: '1.0.0',
      communicationType: CommType.REST,
      criticalityLevel: Criticality.MEDIUM,
    ...
    },
    {
      ...
      currentVersion: '1.0.0',
      communicationType: CommType.ASYNC_EVENT,
      criticalityLevel: Criticality.HIGH,
